...
import { Box, Button, Card, Container, FormControl, Grid, MenuItem, Select, Tab, Tabs } from '@mui/material';
...
export default function SchedulerPage() {
  ...
  const handleDateFilterWeek = date => {
     ...
     for (let i = weekDay; i <= 6; i++) {
        ...
        const filterNextDay = moment(startOfWeek).add(i, 'days').format('MM/DD/YY');
        setWeekDay(value => {
           return value + 1;
        });
  ...
  useEffect(() => {
     try {
        ...
        const todayDayText = todayText + ', ' + todayMonthText + ' ' + todayDayNumber;
        setTodayText(todayDayText);

        const from_date = moment(value).startOf('week').add(1, 'days').format('MM/DD/YYYY').toString();
        const to_date = moment(value).endOf('week').add(1, 'days').format('MM/DD/YYYY').toString();
        ...
        const day1Text = currentDayText + ', ' + currentDayMonthText + ' ' + currentDayNumber;
        setDay1Text(day1Text);

        const currentDayText2 = moment(from_date).add(1, 'days').format('ddd').toString();
        const currentDayMonthText2 = moment(from_date).add(1, 'days').format('MMM').toString();
        const currentDayNumber2 = moment(from_date).add(1, 'days').format('D').toString();
        const day2Text = currentDayText2 + ', ' + currentDayMonthText2 + ' ' + currentDayNumber2;
        setDay2Text(day2Text);

        const currentDayText3 = moment(from_date).add(2, 'days').format('ddd').toString();
        const currentDayMonthText3 = moment(from_date).add(2, 'days').format('MMM').toString();
        const currentDayNumber3 = moment(from_date).add(2, 'days').format('D').toString();
        const day3Text = currentDayText3 + ', ' + currentDayMonthText3 + ' ' + currentDayNumber3;
        setDay3Text(day3Text);

        const currentDayText4 = moment(from_date).add(3, 'days').format('ddd').toString();
        const currentDayMonthText4 = moment(from_date).add(3, 'days').format('MMM').toString();
        const currentDayNumber4 = moment(from_date).add(3, 'days').format('D').toString();
        const day4Text = currentDayText4 + ', ' + currentDayMonthText4 + ' ' + currentDayNumber4;
        setDay4Text(day4Text);

        const currentDayText5 = moment(from_date).add(4, 'days').format('ddd').toString();
        const currentDayMonthText5 = moment(from_date).add(4, 'days').format('MMM').toString();
        const currentDayNumber5 = moment(from_date).add(4, 'days').format('D').toString();
        const day5Text = currentDayText5 + ', ' + currentDayMonthText5 + ' ' + currentDayNumber5;
        setDay5Text(day5Text);

        const currentDayText6 = moment(from_date).add(5, 'days').format('ddd').toString();
        const currentDayMonthText6 = moment(from_date).add(5, 'days').format('MMM').toString();
        const currentDayNumber6 = moment(from_date).add(5, 'days').format('D').toString();
        const day6Text = currentDayText6 + ', ' + currentDayMonthText6 + ' ' + currentDayNumber6;
        setDay6Text(day6Text);

        const currentDayText7 = moment(from_date).add(6, 'days').format('ddd').toString();
        const currentDayMonthText7 = moment(from_date).add(6, 'days').format('MMM').toString();
        const currentDayNumber7 = moment(from_date).add(6, 'days').format('D').toString();
        const day7Text = currentDayText7 + ', ' + currentDayMonthText7 + ' ' + currentDayNumber7;
  ...
  const handleDateFilterMonth = date => {
     ...
     for (let i = 0; i < +loopEnd; i++) {
        const dateIteration = moment(startOfMonth).add(i, 'days').format('MM/DD/YY');
     ...
     if (overType === 'parent') {
        if (active.id !== over.id) {
           if (activeType === 'parent') {
              ...
              const activeContainerIndex = schedules.findIndex(container => container.id === activeContainer.id);
        ...
        if (active.id !== over.id) {
           if (activeContainer.id === overContainer.id) {
              ...
              const activeContainerIndex = schedules.findIndex(container => container.id === activeContainer.id);
              const overContainerIndex = schedules.findIndex(container => container.id === overContainer.id);
              const activeIndex = activeSubList.findIndex(sub => sub.id === active.id);
  ...
  const moveBetweenContainers = (
     ...
     const updatedList = {
        ...
        [overContainerIndex]: {
           ...overContainer,
           shifts: insertAtIndex(items[overContainerIndex].shifts, overIndex, item.data.current.item)
        }
     };
  ...
  // const itemIds = useMemo(() => currentWeekDates.map((currentWeekDay) => currentWeekDay.id), [currentWeekDates]);
           ...
           <div className={styles.schedulerContainer}>
              <Card className={styles.cardContainer}>
                 <Grid
                    ...
                    direction='row'
                    spacing={0}
                    className={classnames('alignBaseline', 'pagePadding', styles.topArea)}
                 >
                    <Grid item xs={2.5}>
                       <Tabs
                       ...
                       <FormControl>
                          <Select
                             ...
                             renderValue={value => {
                                return (
                                   <Box>
                                      <img src={BuildIcon} width={12} height={12} alt='Tools' />
                                      {value}
                                   </Box>
                                );
                             }}
                       ...
                       <FormControl>
                          <Select
                             ...
                             renderValue={value => {
                                return (
                                   <Box>
                                      <img src={PlusIcon} width={15} height={15} alt='Add' />
                                      {value}
                                   </Box>
                                );
                             }}
                 ...
                 <Grid container direction='row' spacing={0}>
                    <Grid item xs={2} className={classnames(styles.resourceBox, styles.first)}>
                       <FormControl style={{ float: 'right', marginRight: '20px' }}>
                          <Select
                             ...
                             renderValue={value => {
                                return (
                                   <Box>
                                      <img src={SortIcon} width={15} height={12} alt='Sort' />
                                      {value}
                                   </Box>
                                );
                             }}
                    ...
                    <Grid item xs={10} className={styles.dateHeader}>
                       <Grid container>
                          <Grid item xs={boxWidth} className={styles.dateHeaderBox}>
                             <strong className={classnames(todayText === day1Text ? styles.activeDay : '')}>
                                {day1Text}
                             </strong>
                             ...
                             >
                                <Grid item xs={2}>
                                   <img src={SunnyIcon} alt='Sunny' className={styles.weatherIcon} />
                                </Grid>
                                <Grid item xs={5}></Grid>
                                <Grid item xs={3}>
                          ...
                          <Grid item xs={boxWidth} className={styles.dateHeaderBox}>
                             <strong className={classnames(todayText === day2Text ? styles.activeDay : '')}>
                                {day2Text}
                             </strong>
                             ...
                             >
                                <Grid item xs={2}>
                                   <img src={PartlyCloudyIcon} alt='Partly Cloudy' className={styles.weatherIcon} />
                                </Grid>
                                <Grid item xs={5}></Grid>
                                <Grid item xs={3}>
                                   <img src={UserIcon} alt='User' />
                          ...
                          <Grid item xs={boxWidth} className={styles.dateHeaderBox}>
                             <strong className={classnames(todayText === day3Text ? styles.activeDay : '')}>
                                {day3Text}
                             </strong>
                             <small>13.5 hrs / $351.22</small>
                             <Grid
                             ...
                             >
                                <Grid item xs={2}>
                                   <img src={SnowIcon} alt='Snow' className={styles.weatherIcon} />
                                </Grid>
                                <Grid item xs={5}></Grid>
                                <Grid item xs={3}>
                                   <img src={UserIcon} alt='User' />
                          ...
                          <Grid item xs={boxWidth} className={styles.dateHeaderBox}>
                             <strong className={classnames(todayText === day4Text ? styles.activeDay : '')}>
                                {day4Text}
                             </strong>
                             <small>0 hrs / $0</small>
                             <Grid
                             ...
                             >
                                <Grid item xs={2}>
                                   <img src={ThunderIcon} alt='Thunder' className={styles.weatherIcon} />
                                </Grid>
                                <Grid item xs={5}></Grid>
                                <Grid item xs={3}>
                                   <img src={UserIcon} alt='User' />
                          ...
                          <Grid item xs={boxWidth} className={styles.dateHeaderBox}>
                             <strong className={classnames(todayText === day5Text ? styles.activeDay : '')}>
                                {day5Text}
                             </strong>
                             <small>0 hrs / $0</small>
                             <Grid
                          ...
                          <Grid item xs={boxWidth} className={styles.dateHeaderBox}>
                             <strong className={classnames(todayText === day6Text ? styles.activeDay : '')}>
                                {day6Text}
                             </strong>
                             <small>0 hrs / $0</small>
                             <Grid
                          ...
                          <Grid item xs={boxWidth} className={classnames(styles.dateHeaderBox, styles.last)}>
                             <strong className={classnames(todayText === day7Text ? styles.activeDay : '')}>
                                {day7Text}
                             </strong>
                             <small>0 hrs / $0</small>
                             <Grid
                 ...
                 <div className={styles.calendarContainer} id={styles.scrollBarContainer}>
                       ...
                       ? positions.map((position, index) => (
                            <Grid container direction='row' spacing={0} key={index}>
                               <Grid item xs={2} className={classnames(styles.resourceBox, styles.first)}>
                                  ...
                                  <p>
                                     {position.hours} hrs / ${position.sales} / {position.notes}
                                  </p>
                               </Grid>
                               <Grid item xs={10}>
                                  <Grid container direction='row' spacing={0}>
                                     ...
                                     >
                                        {schedules.map(
                                           (schedule, index) =>
                                              ...
                                              schedule.position === position.type && (
                                                 <Grid item xs={boxWidth} key={index} className={styles.dateBox}>
                                                    <SortableContext
                                                       items={schedules}
                       ...
                       : employees.map((employee, index) => (
                            <Grid container direction='row' spacing={0} key={index}>
                               <Grid item xs={2} className={classnames(styles.resourceBox, styles.first)}>
                                  ...
                                  <p>
                                     {employee.hours} hrs / ${employee.sales} / {employee.notes}
                                  </p>
                               </Grid>
                               <Grid item xs={10}>
                                  <Grid container direction='row' spacing={0}>
